                    ...
                    <div class="col-xl-12">
                        <div class="row d-flex justify-content-between align-items-center">
                            <div class="header-info-left">
                                <ul>     
                                    <li class="title"><span class="flaticon-energy"></span> TECNOLOGIA</li>
                                    <li>Presidente Lula decide implantar programação nas escolas estaduais</li>
                                </ul>
                            </div>
                            <div class="header-info-right">
                                <ul class="header-date">
                                    <li><span class="flaticon-calendar"></span>19/05/2023 às 15:24</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="main-menu d-none d-md-block">
                                <nav>                  
                                    <ul id="navigation">
                                        ...
                                        <li><a href="contact.html">Colaborar</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>             
